...
declare class Timer extends React.PureComponent<TimerProps, TimerState> {
    static Consumer: React.Consumer<TimerContextType>;
    static Milliseconds: React.SFC<TimerValueItemProps>;
    static Seconds: React.SFC<TimerValueItemProps>;
    static Minutes: React.SFC<TimerValueItemProps>;
    static Hours: React.SFC<TimerValueItemProps>;
    static Days: React.SFC<TimerValueItemProps>;
    static defaultProps: {
        timeToUpdate: number;
        direction: string;
        initialTime: number;
